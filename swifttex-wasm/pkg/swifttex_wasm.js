/* @ts-self-types="./swifttex_wasm.d.ts" */
 ...
 */
export function register_symbol(name, unicode_char) {
    const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(unicode_char, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    wasm.register_symbol(ptr0, len0, ptr1, len1);
}
...
export function render(input, opts) {
    ...
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.render(ptr0, len0, opts);
    return ret;
}

export function reset_registry() {
    wasm.reset_registry();
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('swifttex_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
